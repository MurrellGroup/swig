...
if (!["truth_optimized", "igblast_compatible", "igblast_balanced", "r_optimized", "sensitive_d"].includes(callingProfile)) throw new Error(`Unknown calling profile: ${callingProfile}`);
...
if (typeof runtime.swig_set_calling_profile === "function") {
  const result = runtime.swig_set_calling_profile(
    callingProfile === "truth_optimized" ? 0 : callingProfile === "r_optimized" ? 2 : callingProfile === "sensitive_d" ? 3 : 1,
  );
