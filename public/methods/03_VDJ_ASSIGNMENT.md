...
- R-optimized was retuned on two supplied simulator regimes but is not external biological validation. Very short retained D tracts remain difficult to distinguish from chance junction matches; use the legacy AER-R profile when retaining maximal short-D sensitivity is more important than suppressing chance D calls.
