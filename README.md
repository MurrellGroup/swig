...
- **Lineage figures and inspection:** abundance distribution, largest components, and V/J use are rendered as customizable SVG figures with CSV data exports. The largest lineages are clickable; only the selected component's AIRR rows are decompressed.
