...
const FIELD_HELP: Record<string,string> = {
  ...
  "calling profile":"Selects the calibrated segment scoring and tie-reporting parameter set. R-optimized and Sensitive-D are restricted to AER-R.",
...
function callingProfileLabel(value: CallingProfile): string {
  ...
  if (value === "sensitive_d") return "Sensitive-D";
